...
## 5.1 Hotspot-to-Story Protocol

当用户要求“结合今天热点”或未提供选题时，主动联网搜索当天与近 7 天公开信号，不等待用户喂热点。至少收集 10 条候选信号，优先官方、主流媒体、平台热榜和原始发布者，并对新闻、政策、人物和社会事件做交叉核验。

- 热点池记录：名称、时间、来源、已确认事实、用户情绪、争议、生活影响和同质化风险。
- 先找“大热点下面的普通人问题”，不要把热搜标题直接改成科普标题。
- 每个账号先形成 5 个候选命题，再按人群相关度、人设匹配、场景代入、评论潜力、冲突、收藏分享、时效和差异化选 1 个。
- 无法核实的信号不得写成确定事实，可明确标注“网上正在讨论”或放弃使用。

## 5.2 Human Story Output

抖音图文优先写成“起点 → 变化 → 冲突 → 选择 → 结果 → 落点”的生活故事。正文保持第一人称、口语化和具体动作；每格至少有两个可视觉化元素。热点只负责触发故事，人物经验和生活冲突负责内容价值。

互动必须来自正文中的真实分歧或选择，提供可直接置顶的具体评论问题；第 6 图给出自然的后续内容理由，不使用机械“点赞关注”。
